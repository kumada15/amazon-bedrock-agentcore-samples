#!/usr/bin/env python3
"""
Cognito からユーザー名/パスワードを使用して OAuth2 アクセストークンを取得する。
.a2a.config から設定を読み込み、AWS Cognito で認証を行う。
"""
...
class CognitoAuthenticator:
    ...
    def get_config_from_stack(self, stack_name: str) -> Dict[str, str]:
        """CloudFormation スタックの出力から Cognito 設定を抽出する"""
