...
class TestUserPreference:
    """UserPreference モデルのテスト。"""

    def test_user_preference_creation(self):
        """UserPreference インスタンスの作成をテストする。"""
    ...
    def test_user_preference_without_context(self):
        """コンテキストなしで UserPreference を作成するテスト。"""
        preference = UserPreference(
            user_id="user123",
...
class TestInfrastructureKnowledge:
    """InfrastructureKnowledge モデルのテスト。"""

    def test_infrastructure_knowledge_creation(self):
        """InfrastructureKnowledge インスタンスの作成をテストする。"""
...
class TestInvestigationSummary:
    """InvestigationSummary モデルのテスト。"""

    def test_investigation_summary_creation(self):
        """InvestigationSummary インスタンスの作成をテストする。"""
    ...
    def test_investigation_summary_empty_lists(self):
        """空のリストで InvestigationSummary をテストする。"""
        summary = InvestigationSummary(
