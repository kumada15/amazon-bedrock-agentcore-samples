...
Visa Payment API 統合用の AWS Lambda プロキシです。
...
デプロイ後、出力から API Gateway URL をコピーして `web-ui/.env.local` を更新：
...
- **Lambda 関数**: Flask + Mangum を含む Python 3.11 コンテナ
- **API Gateway**: `/api/visa/*` プロキシルートを持つ REST API
...
完全なデプロイガイドについては、この README と `../../docs/VISA_LOCAL_SETUP.md` を参照してください。
