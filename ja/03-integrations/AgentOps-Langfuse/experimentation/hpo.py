...
def main():
    ...
    for model in models:
        for prompt in system_prompts:
            ...
            try:
                ...
                print(f"✗ {combination_key}のデプロイ中にエラーが発生しました: {str(e)}\n")
    ...
    for agent_info in deployed_agents:
        ...
        try:
            ...
            print(f"✗ {combination_key}の実験実行中にエラーが発生しました: {str(e)}\n")
    ...
    for agent_info in deployed_agents:
        ...
        try:
            ...
            print(f"✗ {combination_key}の削除中にエラーが発生しました: {str(e)}\n")
