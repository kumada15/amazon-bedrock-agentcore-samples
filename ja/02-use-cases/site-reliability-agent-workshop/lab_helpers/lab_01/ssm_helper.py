"""
SSM Parameter Store からインフラリソース ID を取得するヘルパー関数
"""
...
def get_stack_resources(region_name: str, profile_name: str = None) -> Dict[str, str]:
    """
    SSM 経由で CloudFormation スタックから主要なリソース識別子を取得。
    ...
    try:
        ...
        # CloudFormation テンプレートによって作成された SSM パラメータのマッピング
        ssm_mappings = {
