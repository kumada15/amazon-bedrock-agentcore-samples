...
このプロジェクトは 2025年10月に初めて発表しました（[pdf スライド](https://static.langfuse.com/events/2025_10_continuous_agent_evaluation_with_amazon_bedrock_agentcore_and_langfuse.pdf)）。
...
評価者の拡張、新しい実験タイプの追加、エージェント実装の改善を自由に行ってください。貢献対象領域:
