...
Strands 予防エージェントと AgentCore Browser を Amazon Bedrock AgentCore Runtime にデプロイする。
...
class AgentCoreRuntimeDeployer:
    """Strands 予防エージェントを AgentCore Runtime にデプロイするためのヘルパー"""
    ...
    def package_agent_code(
        ...
        """
        デプロイ用に Strands 予防エージェントコードをパッケージ化する。
