"""
LocalMCP MCP Server 用の自動車保険 API ツール
"""
...
def register_insurance_tools(mcp):
    """すべての自動車保険 API ツールを MCP サーバーに登録"""
    ...
    def get_all_policies() -> str:
        """
        自動車保険システムからすべての保険ポリシーを取得

        Returns:
            フォーマットされたテキストのすべてのポリシーリスト
        """
        try:
    ...
    def get_policy_by_id(policy_id: str) -> str:
        ...
        Args:
            policy_id: 検索するポリシー ID

        Returns:
            フォーマットされたテキストのポリシー情報
        """
        try:
    ...
    def get_customer_policies(customer_id: str) -> str:
        ...
        Args:
            customer_id: ポリシーを検索する顧客 ID

        Returns:
            フォーマットされたテキストの顧客のポリシーリスト
        """
        try:
