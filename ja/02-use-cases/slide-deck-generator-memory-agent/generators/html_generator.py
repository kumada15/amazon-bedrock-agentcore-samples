"""
プレゼンテーションスライド作成用の HTML スライドジェネレーター
"""
...
class HTMLSlideGenerator:
    """コンテンツとスタイリング好みから HTML スライドを生成するクラス"""
...
<body>
    ...
    def create_style_preferences_from_params(
        ...
        """後方互換性のためにシンプルなパラメータから StylePreferences オブジェクトを作成する"""
    ...
    def generate_presentation(
        ...
        """高度なスタイリング付きの完全な HTML プレゼンテーションを生成する"""
