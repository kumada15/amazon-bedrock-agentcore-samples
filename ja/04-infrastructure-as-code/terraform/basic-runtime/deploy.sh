...
print_info "Basic AgentCore Runtime のデプロイを開始しています..."
echo ""
...
print_info "     --payload \$(echo '{\"prompt\": \"こんにちは、調子はどうですか？\"}' | base64) \\"
print_info "     response.json"
echo ""
print_info "   レスポンスを表示:"
print_info "   cat response.json | jq -r '.response'"
echo ""
print_info "2. すべての出力を表示:"
