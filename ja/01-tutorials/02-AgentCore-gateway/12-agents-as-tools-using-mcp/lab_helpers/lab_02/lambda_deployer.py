...
def setup_lab_02_infrastructure(handler_code, region_name=None):
    ...
    print(f"✓ app.py（Lambda ハンドラ）を作成しました")
    print()
    ...
    print("=" * 70)
    print("LAB 02 インフラストラクチャのセットアップ完了")
    print("=" * 70)
    print()
    print("設定サマリー:")
    ...
    print("✓ Lambda コンテナデプロイの準備ができました")
    print()
...
def show_deployment_methods():
    ...
    for method_name, method_info in DEPLOYMENT_METHODS.items():
        ...
        print(f"  VPC 対応: {'✅ はい' if method_info['vpc_compatible'] else '❌ いいえ'}")
